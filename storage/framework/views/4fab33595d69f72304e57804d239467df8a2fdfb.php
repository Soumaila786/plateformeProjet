        ...
        <div class="page-header-info">
            ...
            <div class="page-header-actions">
                ...
                <form method="POST" action="<?php echo e(route('admin.users.toggle-status', $user)); ?>" style="display:inline;">
                    ...
                    <button type="submit" class="btn-save <?php echo e($user->actif ? 'btn-warning' : 'btn-success'); ?>">
        ...
        <div class="form-card-body">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="role-badge role-<?php echo e($user->fonction); ?>">
                ...
                <div class="info-item">
                    ...
                    <span class="role-badge role-<?php echo e($user->matricule); ?>">
                        <?php echo e($user->matricule ?? '—'); ?>
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">
                        <?php echo e(optional($user->dateCreation)->format('d/m/Y') ??
                ...
                <?php if($user->role === 'porteur'): ?>
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">
                            <?php echo e($user->porteur->structure ?? '—'); ?>
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">
                            <?php echo e($user->porteur->specialite ?? '—'); ?>
                ...
                <?php if($user->role === 'validateur'): ?>
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">
                            <?php echo e($user->validateur->dateDebutMandat ?? '—'); ?>
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">
                            <?php echo e($user->validateur->dateFinMandat ?? '—'); ?>
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">
                        <?php echo e($user->approbateur->service ?? '—'); ?>
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">
                        <?php echo e($user->approbateur->poste ?? '—'); ?>
