...
<link rel="stylesheet" href="<?php echo e(asset('css/portDash.css')); ?>">
<?php $__env->stopPush(); ?>
...
<div class="banner">
    <div>
        ...
        <p class="banner-role">Porteur de projet</p>
    </div>
...
<div class="main-grid">
    ...
    <div class="aside">
        ...
        <div class="card">
            ...
            <?php
                $ndot = ['success'=>'#22c55e','danger'=>'#ef4444','warning'=>'#f97316'][$notif->type ?? ''] ?? '#6366f1';
            ?>
            <div class="notif-row">
