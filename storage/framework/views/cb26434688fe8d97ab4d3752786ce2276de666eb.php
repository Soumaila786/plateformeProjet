...
<div class="zone-header">
    ...
    <div class="header-right">
        Exporté par : <?php echo e(optional($exportedBy)->nomComplet ?? '—'); ?><br>
        Le <?php echo e($exportedAt); ?>
...
<div class="zone-info">
    ...
    <div class="info-left">
        ...
        <div class="info-row"><strong>Code projet :</strong> <?php echo e($projet->codeProjet); ?></div>
        <div class="info-row"><strong>Titre :</strong> <?php echo e($projet->titre); ?></div>
        <div class="info-row"><strong>Date début :</strong> <?php echo e(optional($projet->dateDebut)->format('d/m/Y') ?? '—'); ?></div>
        <div class="info-row"><strong>Date fin :</strong> <?php echo e(optional($projet->dateFin)->format('d/m/Y') ?? '—'); ?></div>
        <div class="info-row"><strong>Budget total :</strong> <?php echo e($projet->budgetTotal ? number_format($projet->budgetTotal, 0, ',', ' ').' F CFA' : '—'); ?></div>
        <div class="info-row"><strong>Montant demandé :</strong> <?php echo e($projet->montantDemande ? number_format($projet->montantDemande, 0, ',', ' ').' F CFA' : '—'); ?></div>
        <div class="info-row"><strong>Secteur :</strong> <?php echo e(optional($projet->secteur)->nomSecteur ?? '—'); ?></div>

    </div>

    <div class="info-right">
        <div class="info-box-title">Porteur &amp; Suivi</div>
        <div class="info-row"><strong>Nom du porteur :</strong> <?php echo e(optional($projet->porteur)->nomComplet ?? '—'); ?></div>
        <div class="info-row"><strong>Email :</strong> <?php echo e(optional($projet->porteur)->email ?? '—'); ?></div>
        <div class="info-row"><strong>Date soumission :</strong> <?php echo e(optional($projet->dateSoumission)->format('d/m/Y') ?? '—'); ?></div>
        <div class="info-row"><strong>Date approbation :</strong> <?php echo e(optional($projet->dateApprobation)->format('d/m/Y') ?? '—'); ?></div>
        <div class="info-row"><strong>Durée :</strong> <?php echo e($projet->duree ? $projet->duree.' mois' : '—'); ?></div>
        <div class="info-row"><strong>Objectif :</strong> <?php echo e($projet->objectif ?? '—'); ?></div>
...
<div class="zone-planif">
    ...
    <div class="planif-grid">
        <div class="planif-cell">
            <strong>Activité planifiée :</strong>&nbsp;<?php echo e($projet->planification->activitePlanification ?? '—'); ?>

        </div>
        <div class="planif-cell">
            <strong>Indicateur :</strong>&nbsp;<?php echo e($projet->planification->indicateur ?? '—'); ?>

        </div>
        <div class="planif-cell">
            <strong>Unité de mesure :</strong>&nbsp;<?php echo e($projet->planification->uniteIndicateur ?? '—'); ?>

        </div>
        <div class="planif-cell">
            <strong>Période :</strong>&nbsp;<?php echo e($projet->planification->periode ?? '—'); ?>

        </div>
        <div class="planif-cell">
            <strong>Coût estimatif :</strong>&nbsp;<?php echo e($projet->planification->coutEstimatif ? number_format($projet->planification->coutEstimatif, 0, ',', ' ').' F CFA' : '—'); ?>

        </div>
        <?php if($projet->planification->resultatsAttendues): ?>
        <div class="planif-cell full">
            <strong>Résultats attendus :</strong>&nbsp;<?php echo e($projet->planification->resultatsAttendues); ?>
...
<div class="zone-activites">
    <div class="zone-title">Tableau des activités (<?php echo e($projet->activites->count()); ?>)</div>
    ...
    <table class="act-table">
        ...
        <tbody>
            <?php $__currentLoopData = $projet->activites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td class="col-num"><?php echo e($loop->iteration); ?></td>
                <td class="col-act" style="font-weight:600;"><?php echo e($act->activite); ?></td>
                <td class="col-date"><?php echo e(optional($act->dateDebut)->format('d/m/Y') ?? '—'); ?></td>
                <td class="col-date"><?php echo e(optional($act->dateFin)->format('d/m/Y') ?? '—'); ?></td>
                <td class="col-montant"><?php echo e($act->montantDemande ? number_format($act->montantDemande, 0, ',', ' ').' F CFA' : '—'); ?></td>
    ...
    <div class="act-total">
        Total : <?php echo e(number_format($projet->activites->sum('montantDemande'), 0, ',', ' ')); ?> F CFA
    </div>
    <?php else: ?>
