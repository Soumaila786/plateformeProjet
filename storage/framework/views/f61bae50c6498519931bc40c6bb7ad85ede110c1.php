<?php $__env->startSection('title', 'Créer la planification'); ?>
...
<div class="vpage">
    ...
    <form method="POST" action="<?php echo e(route('approbateur.planification.store', $projet)); ?>">
        <?php echo csrf_field(); ?>
        <div class="info-card">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\Laravel\projetSoutenance\resources\views/approbateur/planification/create.blade.php ENDPATH**/ ?>