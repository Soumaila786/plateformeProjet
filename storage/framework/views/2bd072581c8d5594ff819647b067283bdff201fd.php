            ...
            <div class="form-card-body">
                <div class="form-row">
                    <div class="form-col form-col-full">
                        ...
                        <input type="text" name="titre" value="<?php echo e(old('titre', $projet->titre)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-col">
                        ...
                        <input type="number" name="duree" value="<?php echo e(old('duree', $projet->duree)); ?>"
            ...
            <div class="form-card-body">
                <div class="form-row">
                    <div class="form-col">
                        ...
                        <input type="number" name="budgetTotal" value="<?php echo e(old('budgetTotal', $projet->budgetTotal)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-col">
                        ...
                        <input type="number" name="montantDemande" value="<?php echo e(old('montantDemande', $projet->montantDemande)); ?>"
