...
<div class="adash">
    ...
    <div class="ad-banner">
        <div>
            ...
            <p class="ad-banner-role"><?php echo e(Auth::user()->email); ?> &middot; <?php echo e(\Carbon\Carbon::now()->translatedFormat('d F Y')); ?></p>
        </div>
    ...
    <div class="ad-stats">
        <div class="ad-stat">
            <div class="ad-stat-top">
                <span class="ad-stat-lbl">Total</span>
                <div class="ad-stat-ic"><i class="fas fa-folder"></i></div>
            </div>
        ...
        <div class="ad-stat">
            <div class="ad-stat-top">
                <span class="ad-stat-lbl">Soumis</span>
                <div class="ad-stat-ic"><i class="fas fa-paper-plane"></i></div>
            </div>
        ...
        <div class="ad-stat">
            <div class="ad-stat-top">
                <span class="ad-stat-lbl">En examen</span>
                <div class="ad-stat-ic"><i class="fas fa-search"></i></div>
            </div>
        ...
        <div class="ad-stat">
            <div class="ad-stat-top">
                <span class="ad-stat-lbl">Approuvés</span>
                <div class="ad-stat-ic"><i class="fas fa-check-circle"></i></div>
            </div>
        ...
        <div class="ad-stat">
            <div class="ad-stat-top">
                <span class="ad-stat-lbl">Validés</span>
                <div class="ad-stat-ic"><i class="fas fa-medal"></i></div>
            </div>
        ...
        <div class="ad-stat">
            <div class="ad-stat-top">
                <span class="ad-stat-lbl">Rejetés</span>
                <div class="ad-stat-ic"><i class="fas fa-times-circle"></i></div>
            </div>
        ...
        <div class="ad-aside">
            ...
            <div class="card action-card">
                ...
                <a href="<?php echo e(route('approbateur.projets.show', $p)); ?>" class="action-row">
                    <span class="dot"
                            style="background:<?php echo e($p->statutProjet === 'en_examen' ? '#f97316' : '#6366f1'); ?>;
