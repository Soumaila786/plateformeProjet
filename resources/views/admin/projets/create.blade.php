...
<div class="projets-page">
    ...
    <form action="{{ route('admin.projets.store') }}" method="POST" class="projet-form" enctype="multipart/form-data">
        @csrf
            ...
            <div class="form-card-body">
                <div class="form-row">
                    ...
                    <div class="form-col">
                        ...
                        <select name="porteur_id" class="field-input @error('porteur_id') is-invalid @enderror" required>
                            <option value="">— Sélectionner —</option>
                        ...
                        @error('porteur_id')<span class="field-error">{{ $message }}</span>@enderror
                    </div>
                    ...
                    <div class="form-col">
                        ...
                        <select name="statutProjet" class="field-input @error('statutProjet') is-invalid @enderror" required>
                            <option value="brouillon" {{ old('statutProjet', 'brouillon') == 'brouillon' ? 'selected' : '' }}>Brouillon</option>
                            <option value="soumis" {{ old('statutProjet') == 'soumis' ? 'selected' : '' }}>Soumis</option>
                            <option value="en_examen" {{ old('statutProjet') == 'en_examen' ? 'selected' : '' }}>En examen</option>
                            <option value="approuve" {{ old('statutProjet') == 'approuve' ? 'selected' : '' }}>Approuvé</option>
                            <option value="valide" {{ old('statutProjet') == 'valide' ? 'selected' : '' }}>Validé</option>
                            <option value="rejete" {{ old('statutProjet') == 'rejete' ? 'selected' : '' }}>Rejeté</option>
                        </select>
    ...
    function renderFiles() {
        ...
        fileList.innerHTML = selectedFiles.map(f => `
            <div class="doc-file-item">
                ...
                <button type="button" class="doc-file-remove" onclick="removeFile('${f.name.replace(/'/g, "\\'")}')">
